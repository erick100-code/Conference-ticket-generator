...
const Tick = () => {
    ...
    return (
        <div className="min-h-screen w-full flex flex-col bg-[url('/images/background-mobile.png')] bg-cover bg-no-repeat bg-right-bottom relative">
            <div className="overflow-hidden w-full h-full absolute">
                <div className='bg-[url("/images/pattern-lines.svg")] bg-cover bg-no-repeat  w-screen h-[900px] bg-center absolute z-0 top-0 left-0'></div>
            ...
            <div className="text-center z-10 h-full w-full text-white flex flex-col items-center pt-10 px-4 gap-[30px_0px]">
                <div><img src="/images/logo-full.svg" alt="logo"  /></div>
                ...
                <div className="relative landscape:pb-7 mt-20">
                    <img src="/images/pattern-ticket.svg" alt="" className="lg:h-[250px]"/>
                    <div className="absolute top-[20px] left-[20px] flex flex-col gap-[40px_0px] landscape:gap-[120px_0px] lg:landscape:gap-[80px]">
                        ...
                        <div className=" flex gap-[0px_10px] text-left">
                            ...
                            <div>
                                ...
                                <p className="flex gap-[0px_5px] truncate max-w-[370px] portrait:max-w-[230px]"><span><img src="/images/icon-github.svg" alt="" /></span>{data.git}</p>
                            </div>
                        </div>
                    </div>
