...
const Tick = () => {
    ...
    return (
        <div className="min-h-screen w-full flex flex-col bg-[url('/Conference-ticket-generator/images/background-mobile.png')] bg-cover bg-no-repeat bg-right-bottom relative">
