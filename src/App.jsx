...
const App = () => {
    ...
    useEffect(() => {
        if (window.innerWidth >= 1024) {
            imgf.current.setAttribute('src','/images/pattern-squiggly-line-bottom-desktop.svg')
    ...
    return (
    <div className=' w-screen min-h-screen overflow-x-hidden bg-[url("/images/background-mobile.png")] bg-cover bg-no-repeat bg-right-bottom'>
            <section className='text-white flex flex-col items-center gap-[30px_0px] p-5 pt-10 pb-28 relative'>
                ...
                <img ref={imgf} src="/images/pattern-squiggly-line-bottom-mobile-tablet.svg" alt="falha ao carregar imagem"  className='object-cover'/>
                </div>
